...
{
  text: "Om te starten click op de planeet",
  pass_criteria: state => {return state.score > 0;} },

{
  text: "Blijf clicken en koop meer upgrades!!!",
  pass_criteria: state => {return Object.values(state.upgrades).find(val => val.level);} },

{
  text: "De laatste upgrade werkt nog niet.",
...
const DEFAULT_UPGRADES = {
  ...
  AUTOCLICK: {
    ...
    description: "clicked automatish",
    baseMultiplier: 0,
    level: 0,
    requiredUpgrades: false,
    cost: 50,
  ...
  VOYAGER: {
    displayName: "Voyager",
    description: "automatish clicked meer",
    baseMultiplier: 0,
    level: 0,
    requiredUpgrades: false,
    cost: 250,
  ...
  ROVER: {
    displayName: "Rover",
    description: "vermenigvuldigd alle recources",
    baseMultiplier: 0,
    level: 0,
    requiredUpgrades: false,
    cost: 1000,
  ...
  // NEW_PLANET: {
  //   displayName: "Specail planet (still not wroking D:)",
